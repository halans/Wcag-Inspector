...
// .wrangler/tmp/bundle-SSsYyt/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-SSsYyt/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-SSsYyt/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var PgTable = class extends Table {
  /**@internal */
  [(_a106 = entityKind, InlineForeignKeys)] = [];
  /** @internal */
  [EnableRLS] = false;
  /** @internal */
...
__publicField(PgTable, _a106, "PgTable");
/** @internal */
...
function processCreateParams(params) {
  ...
  const customMap = /* @__PURE__ */ __name((iss, ctx) => {
    ...
    if (typeof ctx.data === "undefined") {
      return { message: (_a108 = message !== null && message !== void 0 ? message : required_error) !== null && _a108 !== void 0 ? _a108 : ctx.defaultError };
    }
...
var ZodType = class {
  ...
  safeParse(data2, params) {
    ...
    const ctx = {
      common: {
        issues: [],
        async: (_a108 = params === null || params === void 0 ? void 0 : params.async) !== null && _a108 !== void 0 ? _a108 : false,
...
var ZodString = class extends ZodType {
  ...
  datetime(options) {
    ...
    return this._addCheck({
      ...
      offset: (_a108 = options === null || options === void 0 ? void 0 : options.offset) !== null && _a108 !== void 0 ? _a108 : false,
...
ZodString.create = (params) => {
  ...
  return new ZodString({
    ...
    coerce: (_a108 = params === null || params === void 0 ? void 0 : params.coerce) !== null && _a108 !== void 0 ? _a108 : false,
  ...
  strict(message) {
    ...
    return new ZodObject({
      ...
      ...message !== void 0 ? {
        errorMap: (issue, ctx) => {
          var _a108, _b, _c, _d;
          const defaultError = (_c = (_b = (_a108 = this._def).errorMap) === null || _b === void 0 ? void 0 : _b.call(_a108, issue, ctx).message) !== null && _c !== void 0 ? _c : ctx.defaultError;
  ...
  if (check)
    return ZodAny.create().superRefine((data2, ctx) => {
      ...
      if (!check(data2)) {
        ...
        const _fatal = (_b = (_a108 = p.fatal) !== null && _a108 !== void 0 ? _a108 : fatal) !== null && _b !== void 0 ? _b : true;
...
__name(AnalysisUrlValidationError, "AnalysisUrlValidationError");
...
__name(normalizeAnalysisUrl, "normalizeAnalysisUrl");
var analysisUrlSchema = z.string().trim().min(1, analysisUrlErrorMessages["invalid-format"]).transform((value, ctx) => {
  try {
    return normalizeAnalysisUrl(value);
  } catch (error3) {
    if (error3 instanceof AnalysisUrlValidationError) {
      ctx.addIssue({
...
var criteriaResults = pgTable("criteria_results", {
  id: serial("id").primaryKey(),
  ...
  // JSON stringified array of elements
});
var insertCriteriaResultSchema = createInsertSchema(criteriaResults).omit({
  id: true
});
var analysisRequestSchema = z.object({
  url: analysisUrlSchema
});
var criterionResultSchema = z.object({
...
// ../packages/shared/src/analysis/errors.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var UNKNOWN_ERROR_MESSAGE = "An unexpected error occurred. Please try again later.";
...
function invalidUrlError(message, options) {
  return new HttpError(400, "INVALID_URL", message, options);
}
__name(invalidUrlError, "invalidUrlError");
function fetchTimeoutError(timeoutMs, options) {
  const seconds = timeoutMs / 1e3;
  const displaySeconds = Number.isInteger(seconds) ? seconds.toString() : seconds.toFixed(1);
...
__name(fetchTimeoutError, "fetchTimeoutError");
function fetchFailureError(options) {
  return new HttpError(
    502,
    "FETCH_FAILURE",
...
__name(fetchFailureError, "fetchFailureError");
...
// ../packages/shared/src/analysis/accessibility.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
function replaceCodePoint(codePoint) {
  ...
  return (_a108 = decodeMap.get(codePoint)) !== null && _a108 !== void 0 ? _a108 : codePoint;
}
...
var EntityDecoder = class {
  ...
  emitNumericEntity(lastCp, expectedLength) {
    ...
    if (this.consumed <= expectedLength) {
      (_a108 = this.errors) === null || _a108 === void 0 ? void 0 : _a108.absenceOfDigitsInNumericCharacterReference(this.consumed);
      return 0;
    }
  ...
  emitNotTerminatedNamedEntity() {
    ...
    (_a108 = this.errors) === null || _a108 === void 0 ? void 0 : _a108.missingSemicolonAfterCharacterReference();
    return this.consumed;
  }
  /**
   * Emit a named entity.
...
function formatAttributes(attributes2, opts) {
  ...
  if (!attributes2)
    return;
  const encode = ((_a108 = opts.encodeEntities) !== null && _a108 !== void 0 ? _a108 : opts.decodeEntities) === false ? replaceQuotes : opts.xmlMode || opts.encodeEntities !== "utf8" ? encodeXML : escapeAttribute;
  return Object.keys(attributes2).map((key) => {
    var _a109, _b;
    const value = (_a109 = attributes2[key]) !== null && _a109 !== void 0 ? _a109 : "";
...
function renderTag(elem, opts) {
  var _a108;
  if (opts.xmlMode === "foreign") {
    elem.name = (_a108 = elementNames.get(elem.name)) !== null && _a108 !== void 0 ? _a108 : elem.name;
...
function renderText(elem, opts) {
  var _a108;
  let data2 = elem.data || "";
  if (((_a108 = opts.encodeEntities) !== null && _a108 !== void 0 ? _a108 : opts.decodeEntities) !== false && !(!opts.xmlMode && elem.parent && unencodedElements.has(elem.parent.name))) {
...
function getAtomFeed(feedRoot) {
  ...
  const feed = {
    ...
    items: getElementsByTagName("entry", childs).map((item) => {
      ...
      const href2 = (_a109 = getOneElement("link", children2)) === null || _a109 === void 0 ? void 0 : _a109.attribs["href"];
      if (href2) {
        entry.link = href2;
      }
  ...
  const href = (_a108 = getOneElement("link", childs)) === null || _a108 === void 0 ? void 0 : _a108.attribs["href"];
  if (href) {
    feed.link = href;
  }
...
function getRssFeed(feedRoot) {
  var _a108, _b;
  const childs = (_b = (_a108 = getOneElement("channel", feedRoot.children)) === null || _a108 === void 0 ? void 0 : _a108.children) !== null && _b !== void 0 ? _b : [];
  const feed = {
...
function getAttr(elem, name, xmlMode) {
  ...
  if (!elem || !isTag2(elem))
    return void 0;
  (_a108 = elem.attribs) !== null && _a108 !== void 0 ? _a108 : elem.attribs = {};
  if (!name) {
    return elem.attribs;
  }
...
function prop(name, value) {
  ...
  if (typeof name === "string" && value === void 0) {
    ...
    switch (name) {
      ...
      case "href":
      case "src": {
        const prop2 = (_a108 = el.attribs) === null || _a108 === void 0 ? void 0 : _a108[name];
...
function setData(elem, name, value) {
  var _a108;
  (_a108 = elem.data) !== null && _a108 !== void 0 ? _a108 : elem.data = {};
  if (typeof name === "object")
...
function data(name, value) {
  ...
  if (!elem || !isTag2(elem))
    return;
  const dataEl = elem;
  (_a108 = dataEl.data) !== null && _a108 !== void 0 ? _a108 : dataEl.data = {};
  if (name == null) {
...
var attributeRules = {
  ...
  start(next2, data2, options) {
    ...
    return (elem) => {
      var _a108;
      return !!((_a108 = adapter2.getAttributeValue(elem, name)) === null || _a108 === void 0 ? void 0 : _a108.startsWith(value)) && next2(elem);
    };
  },
    ...
    if (shouldIgnoreCase(data2, options)) {
      ...
      return (elem) => {
        var _a108;
        return ((_a108 = adapter2.getAttributeValue(elem, name)) === null || _a108 === void 0 ? void 0 : _a108.substr(len).toLowerCase()) === value && next2(elem);
      };
    }
    return (elem) => {
      var _a108;
      return !!((_a108 = adapter2.getAttributeValue(elem, name)) === null || _a108 === void 0 ? void 0 : _a108.endsWith(value)) && next2(elem);
    };
  },
  any(next2, data2, options) {
    ...
    return (elem) => {
      var _a108;
      return !!((_a108 = adapter2.getAttributeValue(elem, name)) === null || _a108 === void 0 ? void 0 : _a108.includes(value)) && next2(elem);
    };
  },
...
var is2 = /* @__PURE__ */ __name((next2, token, options, context2, compileToken2) => {
...
function compilePseudoSelector(next2, selector, options, context2, compileToken2) {
  ...
  const userPseudo = (_a108 = options.pseudos) === null || _a108 === void 0 ? void 0 : _a108[name];
...
function compileToken(token, options, context2) {
  ...
  context2 = (_a108 = options.context) !== null && _a108 !== void 0 ? _a108 : context2;
...
function compileRules(rules, options, context2) {
  var _a108;
  return rules.reduce((previous, rule) => previous === import_boolbase5.default.falseFunc ? import_boolbase5.default.falseFunc : compileGeneralSelector(previous, rule, options, context2, compileToken), (_a108 = options.rootFunc) !== null && _a108 !== void 0 ? _a108 : import_boolbase5.default.trueFunc);
}
...
function convertOptionFormats(options) {
  ...
  (_a108 = opts.adapter) !== null && _a108 !== void 0 ? _a108 : opts.adapter = esm_exports2;
...
function filterBySelector(selector, elements, options) {
  ...
  if (selector.some(isTraversal)) {
    const root2 = (_a108 = options.root) !== null && _a108 !== void 0 ? _a108 : getDocumentRoot(elements[0]);
...
function _findBySelector(selector, limit) {
  ...
  const options = {
    context: context2,
    root: (_a108 = this._root) === null || _a108 === void 0 ? void 0 : _a108[0],
...
function _getMatcher(matchMap) {
  return function(fn, ...postFns) {
    return function(selector) {
      ...
      if (selector) {
        matched = filterArray(matched, selector, this.options.xmlMode, (_a108 = this._root) === null || _a108 === void 0 ? void 0 : _a108[0]);
      }
      return this._make(
...
function filter3(match2) {
  var _a108;
  return this._make(filterArray(this.toArray(), match2, this.options.xmlMode, (_a108 = this._root) === null || _a108 === void 0 ? void 0 : _a108[0]));
}
...
function eq(i) {
  ...
  if (i < 0)
    i = this.length + i;
  return this._make((_a108 = this[i]) !== null && _a108 !== void 0 ? _a108 : []);
}
__name(eq, "eq");
function get(i) {
  if (i == null) {
...
function end() {
  var _a108;
  return (_a108 = this.prevObject) !== null && _a108 !== void 0 ? _a108 : this._make([]);
}
__name(end, "end");
...
function uniqueSplice(array, spliceIdx, spliceCount, newElems, parent2) {
  ...
  for (let idx = 0; idx < newElems.length; ++idx) {
    ...
    node.parent = parent2;
    if (node.prev) {
      node.prev.next = (_a108 = node.next) !== null && _a108 !== void 0 ? _a108 : null;
    }
    if (node.next) {
...
function serializeArray() {
  return this.map((_, elem) => {
    ...
    const value = (_a108 = $elem.val()) !== null && _a108 !== void 0 ? _a108 : "";
...
function getExtractDescr(descr) {
  ...
  return {
    ...
    value: (_a108 = descr.value) !== null && _a108 !== void 0 ? _a108 : "textContent"
  };
}
...
function getTagID(tagName) {
  var _a108;
  return (_a108 = TAG_NAME_TO_ID.get(tagName)) !== null && _a108 !== void 0 ? _a108 : TAG_ID.UNKNOWN;
}
...
var Tokenizer = class {
  ...
  _err(code, cpOffset = 0) {
    var _a108, _b;
    (_b = (_a108 = this.handler).onParseError) === null || _b === void 0 ? void 0 : _b.call(_a108, this.preprocessor.getError(code, cpOffset));
  }
  ...
  _leaveAttrName() {
    ...
    if (getTokenAttr(token, this.currentAttr.name) === null) {
      ...
      if (token.location && this.currentLocation) {
        const attrLocations = (_a108 = (_b = token.location).attrs) !== null && _a108 !== void 0 ? _a108 : _b.attrs = /* @__PURE__ */ Object.create(null);
...
var Parser = class {
  ...
  _err(token, code, beforeToken) {
    ...
    if (!this.onParseError)
      return;
    const loc = (_a108 = token.location) !== null && _a108 !== void 0 ? _a108 : BASE_LOC;
    const err = {
      code,
  ...
  onItemPush(node, tid, isTop) {
    var _a108, _b;
    (_b = (_a108 = this.treeAdapter).onItemPush) === null || _b === void 0 ? void 0 : _b.call(_a108, node);
  ...
  onItemPop(node, isTop) {
    ...
    (_b = (_a108 = this.treeAdapter).onItemPop) === null || _b === void 0 ? void 0 : _b.call(_a108, node, this.openElements.current);
    if (isTop) {
      let current;
      let currentTagId;
...
function endTagInText(p, token) {
  ...
  if (token.tagID === TAG_ID.SCRIPT) {
    (_a108 = p.scriptHandler) === null || _a108 === void 0 ? void 0 : _a108.call(p, p.openElements.current);
  }
  p.openElements.pop();
...
function endTagAfterBody(p, token) {
  ...
  if (token.tagID === TAG_ID.HTML) {
    ...
    if (p.options.sourceCodeLocationInfo && p.openElements.tagIDs[0] === TAG_ID.HTML) {
      ...
      const bodyElement = p.openElements.items[1];
      if (bodyElement && !((_a108 = p.treeAdapter.getNodeSourceCodeLocation(bodyElement)) === null || _a108 === void 0 ? void 0 : _a108.endTag)) {
        p._setEndLocation(bodyElement, token);
      }
    }
  } else {
...
var adapter = {
  ...
  getDocumentTypeNodeName(doctypeNode) {
    var _a108;
    return (_a108 = doctypeNode["x-name"]) !== null && _a108 !== void 0 ? _a108 : "";
  },
  getDocumentTypeNodePublicId(doctypeNode) {
    var _a108;
    return (_a108 = doctypeNode["x-publicId"]) !== null && _a108 !== void 0 ? _a108 : "";
  },
  getDocumentTypeNodeSystemId(doctypeNode) {
    var _a108;
    return (_a108 = doctypeNode["x-systemId"]) !== null && _a108 !== void 0 ? _a108 : "";
  },
  //Node types
  isDocumentTypeNode(node) {
...
function parseWithParse5(content, options, isDocument2, context2) {
  var _a108;
  (_a108 = options.treeAdapter) !== null && _a108 !== void 0 ? _a108 : options.treeAdapter = adapter;
...
var Parser2 = class {
  constructor(cbs, options = {}) {
    ...
    this.lowerCaseTagNames = (_a108 = options.lowerCaseTags) !== null && _a108 !== void 0 ? _a108 : this.htmlMode;
  ...
  ontext(start, endIndex) {
    ...
    (_b = (_a108 = this.cbs).ontext) === null || _b === void 0 ? void 0 : _b.call(_a108, data2);
  ...
  ontextentity(cp, endIndex) {
    var _a108, _b;
    this.endIndex = endIndex - 1;
    (_b = (_a108 = this.cbs).ontext) === null || _b === void 0 ? void 0 : _b.call(_a108, fromCodePoint(cp));
    this.startIndex = endIndex;
  }
  /**
  ...
  emitOpenTag(name) {
    ...
    if (impliesClose) {
      while (this.stack.length > 0 && impliesClose.has(this.stack[0])) {
        ...
        (_b = (_a108 = this.cbs).onclosetag) === null || _b === void 0 ? void 0 : _b.call(_a108, element, true);
      }
    }
  ...
  endOpenTag(isImplied) {
    ...
    if (this.attribs) {
      (_b = (_a108 = this.cbs).onopentag) === null || _b === void 0 ? void 0 : _b.call(_a108, this.tagname, this.attribs, isImplied);
      this.attribs = null;
    }
    ...
    if (!this.isVoidElement(name)) {
      ...
      if (pos !== -1) {
        for (let index2 = 0; index2 <= pos; index2++) {
          const element = this.stack.shift();
          (_b = (_a108 = this.cbs).onclosetag) === null || _b === void 0 ? void 0 : _b.call(_a108, element, index2 !== pos);
        }
  ...
  closeCurrentTag(isOpenImplied) {
    ...
    if (this.stack[0] === name) {
      (_b = (_a108 = this.cbs).onclosetag) === null || _b === void 0 ? void 0 : _b.call(_a108, name, !isOpenImplied);
      this.stack.shift();
    }
  }
  /** @internal */
  ...
  onattribend(quote, endIndex) {
    var _a108, _b;
    this.endIndex = endIndex;
    (_b = (_a108 = this.cbs).onattribute) === null || _b === void 0 ? void 0 : _b.call(_a108, this.attribname, this.attribvalue, quote === QuoteType.Double ? '"' : quote === QuoteType.Single ? "'" : quote === QuoteType.NoValue ? void 0 : null);
  ...
  oncomment(start, endIndex, offset) {
    var _a108, _b, _c, _d;
    this.endIndex = endIndex;
    (_b = (_a108 = this.cbs).oncomment) === null || _b === void 0 ? void 0 : _b.call(_a108, this.getSlice(start, endIndex - offset));
  ...
  oncdata(start, endIndex, offset) {
    ...
    if (!this.htmlMode || this.options.recognizeCDATA) {
      (_b = (_a108 = this.cbs).oncdatastart) === null || _b === void 0 ? void 0 : _b.call(_a108);
  ...
  onend() {
    ...
    (_b = (_a108 = this.cbs).onend) === null || _b === void 0 ? void 0 : _b.call(_a108);
  }
  /**
  ...
  reset() {
    var _a108, _b, _c, _d;
    (_b = (_a108 = this.cbs).onreset) === null || _b === void 0 ? void 0 : _b.call(_a108);
  ...
  write(chunk) {
    var _a108, _b;
    if (this.ended) {
      (_b = (_a108 = this.cbs).onerror) === null || _b === void 0 ? void 0 : _b.call(_a108, new Error(".write() after done!"));
      return;
    }
   ...
   */
    ...
    var _a108, _b;
    if (this.ended) {
      (_b = (_a108 = this.cbs).onerror) === null || _b === void 0 ? void 0 : _b.call(_a108, new Error(".end() after done!"));
      return;
    }
    if (chunk)
      this.write(chunk);
...
function normalizeUrl(url) {
  try {
    ...
    if (error3 instanceof AnalysisUrlValidationError) {
      throw invalidUrlError(error3.message, { cause: error3 });
    }
    throw error3;
  }
}
...
__name(resolveFetchTimeout, "resolveFetchTimeout");
function isAbortError(error3) {
  if (error3 instanceof Error) {
    if (error3.name === "AbortError") {
      return true;
    }
    if ("type" in error3 && typeof error3.type === "string" && error3.type === "aborted") {
      return true;
    }
  }
  return false;
...
function generateSummary(url, passedCount, totalCriteria, results) {
...
function analyzeNonTextContent($2) {
  const images = $2("img");
  const imagesWithoutAlt = [];
  let allImagesHaveAlt = true;
  images.each((_, img) => {
    const element = $2(img);
    const hasAlt = element.attr("alt") !== void 0;
    if (!hasAlt) {
  ...
  return {
    ...
    findings: allImagesHaveAlt ? "All images appear to have alternative text." : "Some images don't have alternative text (alt attribute).",
    elements: imagesWithoutAlt.length > 0 ? imagesWithoutAlt.map((img) => ({
      element: img,
      isPassed: false,
      issue: "Missing alt attribute"
    })) : [{ element: "Images", isPassed: true }],
    howToFix: allImagesHaveAlt ? void 0 : 'Add descriptive alt attributes to all images. For decorative images, use alt="".'
  };
}
__name(analyzeNonTextContent, "analyzeNonTextContent");
function analyzeAudioVideo($2) {
  const audioElements = $2("audio");
  const videoElements = $2("video");
  const possibleVideoPlayers = $2('iframe[src*="youtube"], iframe[src*="vimeo"], div[class*="video"], div[class*="player"]');
  const hasMultimedia = audioElements.length > 0 || videoElements.length > 0 || possibleVideoPlayers.length > 0;
  const hasCaptions = $2('track[kind="captions"], .captions, [class*="caption"]').length > 0;
  return {
    criterionId: "1.2.1",
    ...
    findings: !hasMultimedia ? "No audio or video content was detected on the page." : hasCaptions ? "Multimedia content appears to have captions or alternatives." : "Multimedia content may not have proper alternatives.",
    elements: hasMultimedia ? [{
      element: "Multimedia content",
      isPassed: hasCaptions,
      issue: hasCaptions ? void 0 : "May lack captions or text alternatives"
    }] : [{ element: "No multimedia found", isPassed: true }],
    howToFix: !hasMultimedia || hasCaptions ? void 0 : "Add captions for video content and transcripts for audio content."
  };
}
__name(analyzeAudioVideo, "analyzeAudioVideo");
function analyzeInfoRelationships($2) {
  const forms = $2("form");
  const tables = $2("table");
  let formsHaveLabels = true;
  forms.find("input, select, textarea").each((_, field) => {
    const element = $2(field);
    const id = element.attr("id");
    if (id) {
      const hasLabel = $2(`label[for="${id}"]`).length > 0;
  ...
  tables.each((_, table3) => {
    const hasHeaders = $2(table3).find("th").length > 0;
    if (!hasHeaders) {
  ...
  return {
    ...
    passed,
    findings: passed ? "Form fields appear to have proper labels and tables have headers." : "Some structural elements lack proper semantic markup.",
    elements: [
      {
        element: "Form fields",
        isPassed: formsHaveLabels,
        issue: formsHaveLabels ? void 0 : "Missing labels or associations"
      },
      {
        element: "Tables",
        isPassed: tablesHaveHeaders,
        issue: tablesHaveHeaders ? void 0 : "Missing table headers"
      }
    ],
    howToFix: passed ? void 0 : "Ensure all form fields have labels, and all tables have proper headers and structure."
  };
}
__name(analyzeInfoRelationships, "analyzeInfoRelationships");
function analyzeUseOfColor($2) {
  const hasColorOnlyIndicators = $2("a:not(:has(*))", 'span[style*="color"]').length > 0;
  return {
    criterionId: "1.4.1",
    name: "Use of Color",
    level: "A",
    ...
    passed: true,
    // Defaulting to true since it's hard to detect automatically
...
__name(analyzeUseOfColor, "analyzeUseOfColor");
function analyzeContrast($2) {
  const styleElements = $2("style");
  let potentialContrastIssues = false;
  styleElements.each((_, style) => {
    const styleContent = $2(style).text();
    if (styleContent.includes("color: #fff") || styleContent.includes("color: white") || styleContent.includes("color: #ccc") || styleContent.includes("color: #f") || styleContent.includes("color: rgb(255")) {
  ...
  return {
    ...
    findings: !potentialContrastIssues ? "No obvious contrast issues were detected, but a visual inspection is recommended." : "Potential contrast issues were detected with light-colored text.",
    elements: [
      {
        element: "Text elements",
        isPassed: !potentialContrastIssues,
        issue: potentialContrastIssues ? "Potential low contrast" : void 0
      }
    ],
    howToFix: !potentialContrastIssues ? void 0 : "Ensure text has a contrast ratio of at least 4.5:1 against its background."
  };
}
__name(analyzeContrast, "analyzeContrast");
function analyzeResizeText($2) {
  const elementsWithFixedSizes = $2('[style*="font-size:"], [style*="font-size="]');
  ...
  return {
    ...
    findings: !hasFixedSizes ? "No fixed-size text that would prevent resizing was detected." : "Some elements have fixed font sizes that might cause issues when resizing text.",
    ...
    howToFix: !hasFixedSizes ? void 0 : "Use relative units (em, rem, %) for font sizes instead of fixed pixel values."
  };
}
__name(analyzeResizeText, "analyzeResizeText");
function analyzeKeyboard($2) {
  const potentialIssueElements = $2(
    'div[onclick], span[onclick], a[href="#"][onclick], div[role="button"]:not([tabindex]), span[role="button"]:not([tabindex])'
  );
  ...
  return {
    ...
    findings: !hasKeyboardIssues ? "No obvious keyboard accessibility issues were detected." : "Some elements may not be accessible via keyboard navigation.",
    ...
    howToFix: !hasKeyboardIssues ? void 0 : "Ensure all interactive elements are keyboard accessible. Use proper elements like buttons instead of divs with click handlers, or add tabindex attributes."
  };
}
__name(analyzeKeyboard, "analyzeKeyboard");
function analyzeTimingAdjustable($2) {
  const potentialTimingElements = $2(
    '[class*="timer"], [class*="countdown"], [id*="timer"], [id*="countdown"], meta[http-equiv="refresh"]'
  );
  ...
  return {
    ...
    findings: !hasTimingElements ? "No apparent time limits were detected on the page." : "Potential time limits were detected that might need adjustment options.",
    ...
    howToFix: !hasTimingElements ? void 0 : "Provide options to disable, adjust, or extend any time limits on the page."
  };
}
__name(analyzeTimingAdjustable, "analyzeTimingAdjustable");
function analyzeThreeFlashes($2) {
  const potentialFlashingElements = $2(
    '[class*="flash"], [class*="blink"], [class*="animate"], [style*="animation"]'
  );
  ...
  return {
    ...
    findings: !hasFlashingElements ? "No elements likely to flash were detected." : "Potential flashing or animated elements were detected that should be verified.",
    ...
    howToFix: !hasFlashingElements ? void 0 : "Ensure any flashing or animated content flashes fewer than three times per second or is below the general flash threshold."
  };
}
__name(analyzeThreeFlashes, "analyzeThreeFlashes");
function analyzeBypassBlocks($2, url) {
  const isAnalyzingSelf = url && (url.includes("wcag-inspector.halans.dev") || url.includes("wcag.halans.dev") || url.includes("localhost") || url.includes("http://0.0.0.0") || url.includes("127.0.0.1"));
  if (isAnalyzingSelf) {
    return {
      criterionId: "2.4.1",
      name: "Bypass Blocks",
  ...
  const hasSkipLink = $2('a[href^="#"]:contains("skip"), a[href^="#"]:contains("Skip")').length > 0;
  const hasLandmarks = $2('header, nav, main, footer, [role="banner"], [role="navigation"], [role="main"], [role="contentinfo"]').length > 0;
  ...
  return {
    ...
    description: "A mechanism is available to bypass blocks of content that are repeated on multiple Web pages.",
    passed,
    findings: passed ? hasSkipLink ? "Skip links are available to bypass repeated content." : "Landmark regions are used that allow users to bypass repeated content." : "No mechanism to bypass repeated blocks of content was detected.",
    elements: [
      {
        element: "Skip links",
        isPassed: hasSkipLink,
        issue: hasSkipLink ? void 0 : "Missing skip navigation links"
      },
      {
        element: "Landmark regions",
        isPassed: hasLandmarks,
        issue: hasLandmarks ? void 0 : "Missing HTML5 landmarks or ARIA landmarks"
      }
    ],
    howToFix: passed ? void 0 : "Add skip links at the beginning of the page or implement proper landmark regions using HTML5 elements or ARIA roles."
  };
}
__name(analyzeBypassBlocks, "analyzeBypassBlocks");
function analyzePageTitled($2) {
  const title2 = $2("title").text().trim();
  const hasTitle = title2.length > 0;
  return {
    criterionId: "2.4.2",
    name: "Page Titled",
    level: "A",
    ...
    passed: hasTitle,
    findings: hasTitle ? `The page has a title: "${title2}"` : "The page does not have a title.",
    elements: [
      {
        element: "Page title",
        isPassed: hasTitle,
        issue: hasTitle ? void 0 : "Missing title element"
      }
    ],
    howToFix: hasTitle ? void 0 : "Add a descriptive <title> element to the page that indicates its topic or purpose."
  };
}
__name(analyzePageTitled, "analyzePageTitled");
function analyzeFocusOrder($2) {
  const elementsWithPositiveTabindex = $2('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])');
  ...
  return {
    ...
    findings: !hasPositiveTabindex ? "No elements with positive tabindex values that could disrupt focus order were found." : "Elements with positive tabindex values were found that might disrupt natural focus order.",
    ...
    howToFix: !hasPositiveTabindex ? void 0 : "Avoid using positive tabindex values. Use the natural DOM order or restructure the HTML to achieve the desired focus order."
  };
}
__name(analyzeFocusOrder, "analyzeFocusOrder");
function analyzeLinkPurpose($2) {
  const unclearLinks = $2('a:contains("click here"), a:contains("read more"), a:contains("more"), a:contains("here"), a[href="#"]');
  ...
  return {
    ...
    findings: !hasUnclearLinks ? "Links appear to have descriptive text that indicates their purpose." : "Some links have generic or unclear text that does not indicate their purpose.",
    ...
    howToFix: !hasUnclearLinks ? void 0 : "Use descriptive link text that clearly indicates the link's purpose, avoiding generic phrases like 'click here' or 'read more'."
  };
}
__name(analyzeLinkPurpose, "analyzeLinkPurpose");
function analyzeFocusVisible2($2) {
  const styleElements = $2("style");
  let hasFocusOutlineRemoved = false;
  styleElements.each((_, style) => {
    const styleContent = $2(style).text();
    if (styleContent.includes("outline: none") || styleContent.includes("outline:none") || styleContent.includes("outline: 0") || styleContent.includes("outline:0")) {
  ...
  return {
    ...
    findings: !hasFocusOutlineRemoved ? "No CSS rules that remove focus outlines were detected." : "CSS rules that remove focus outlines were detected, which may make keyboard navigation difficult.",
    elements: [
      {
        element: "CSS styles",
        isPassed: !hasFocusOutlineRemoved,
        issue: hasFocusOutlineRemoved ? "Focus outline removal detected in CSS" : void 0
      }
    ],
    howToFix: !hasFocusOutlineRemoved ? void 0 : "Remove CSS rules that hide focus indicators (e.g., outline: none) or replace them with alternative focus styles."
  };
}
__name(analyzeFocusVisible2, "analyzeFocusVisible2");
function analyzeLanguage($2) {
  const htmlElement = $2("html");
  const hasLangAttribute = htmlElement.attr("lang") !== void 0;
  return {
    criterionId: "3.1.1",
    ...
    findings: hasLangAttribute ? `The page has a language attribute: lang="${htmlElement.attr("lang")}"` : "The page does not have a language attribute on the html element.",
    elements: [
      {
        element: "HTML element",
        isPassed: hasLangAttribute,
        issue: hasLangAttribute ? void 0 : "Missing lang attribute"
      }
    ],
    howToFix: hasLangAttribute ? void 0 : 'Add a lang attribute to the html element, e.g., <html lang="en">.'
  };
}
__name(analyzeLanguage, "analyzeLanguage");
function analyzeOnFocus($2) {
  const potentialIssueElements = $2('select[onchange], input[onchange][type="radio"], input[onchange][type="checkbox"]');
  ...
  return {
    ...
    findings: !hasIssueElements ? "No elements were detected that would likely cause context changes on focus." : "Some elements might cause context changes when receiving focus.",
    elements: hasIssueElements ? [{
      element: "Form controls with onchange",
      isPassed: false,
      issue: "May cause context changes on focus"
    }] : [{ element: "Interactive elements", isPassed: true }],
    howToFix: !hasIssueElements ? void 0 : "Ensure form controls don't automatically submit or change context when focused. Use explicit submit buttons instead of automatic form submission."
  };
}
__name(analyzeOnFocus, "analyzeOnFocus");
function analyzeErrorIdentification($2) {
  const forms = $2("form");
  const hasFormValidation = $2('[required], [aria-required="true"], [data-validate], [class*="validate"], [class*="validation"]').length > 0;
  return {
    criterionId: "3.3.1",
    ...
    findings: forms.length === 0 ? "No forms were detected on the page." : hasFormValidation ? "Form validation appears to be implemented." : "Forms were detected but no clear validation mechanism was found.",
    elements: forms.length > 0 ? [{
      element: "Forms with validation",
      isPassed: hasFormValidation,
      issue: hasFormValidation ? void 0 : "May lack error identification"
    }] : [{ element: "No forms found", isPassed: true }],
    howToFix: forms.length === 0 || hasFormValidation ? void 0 : "Implement form validation that clearly identifies errors and provides text descriptions of the errors."
  };
}
__name(analyzeErrorIdentification, "analyzeErrorIdentification");
function analyzeNameRoleValue($2) {
  const customInteractiveElements = $2("div[onclick], span[onclick], div[role], span[role]");
  let allHaveProperAttributes = true;
  customInteractiveElements.each((_, el) => {
    const element = $2(el);
    const hasRole = element.attr("role") !== void 0;
    const hasName = element.attr("aria-label") !== void 0 || element.attr("aria-labelledby") !== void 0 || element.text().trim().length > 0;
    if (!hasRole || !hasName) {
  ...
  return {
    ...
    findings: customInteractiveElements.length === 0 ? "No custom interactive elements were detected." : allHaveProperAttributes ? "Custom interactive elements have appropriate ARIA attributes." : "Some custom interactive elements may not have proper accessibility attributes.",
    elements: customInteractiveElements.length > 0 ? [{
      element: "Custom interactive elements",
      isPassed: allHaveProperAttributes,
      issue: allHaveProperAttributes ? void 0 : "Missing ARIA attributes"
    }] : [{ element: "Page elements", isPassed: true }],
    howToFix: customInteractiveElements.length === 0 || allHaveProperAttributes ? void 0 : "Add appropriate ARIA roles and labels to custom interactive elements to ensure they are accessible to assistive technologies."
  };
}
__name(analyzeNameRoleValue, "analyzeNameRoleValue");
function analyzeFocusAppearance($2) {
  return {
    criterionId: "2.4.11",
...
__name(analyzeFocusAppearance, "analyzeFocusAppearance");
function analyzeFocusVisible($2) {
  const interactiveElements = $2('a, button, input, select, textarea, [tabindex]:not([tabindex="-1"])');
  const elementsWithoutFocus = [];
  let hasFocusStyles = false;
  const styleElements = $2("style");
  const linkElements = $2('link[rel="stylesheet"]');
  styleElements.each((_, style) => {
    const styleContent = $2(style).text();
    if (styleContent.includes(":focus") || styleContent.includes(":focus-visible") || styleContent.includes("outline") || styleContent.includes("ring")) {
      hasFocusStyles = true;
    }
  });
  const customButtons = $2('button[class*="gradient"], a[class*="gradient"]');
  ...
  return {
    ...
    findings: hasFocusStyles ? "All interactive elements show a visible focus indicator when using keyboard navigation." : "Some interactive elements don't have a visible focus indicator for keyboard users. Custom styled buttons might be overriding focus styles.",
    elements: elementsWithoutFocus.length > 0 ? elementsWithoutFocus.map((el) => ({
      element: el,
      isPassed: false,
      issue: "May have missing or overridden focus styles"
    })) : interactiveElements.length > 0 ? [{ element: "Interactive elements", isPassed: true }] : [{ element: "No interactive elements found", isPassed: true }],
    howToFix: !hasFocusStyles ? "Add explicit :focus-visible styles to all interactive elements, especially those with custom styling. Use outline: 2px solid #4f46e5; outline-offset: 2px; or similar to ensure focus visibility. Avoid overriding built-in focus styles." : void 0
  };
}
__name(analyzeFocusVisible, "analyzeFocusVisible");
function analyzeInputPurpose($2) {
  const inputFields = $2('input[type="text"], input[type="email"], input[type="tel"], input[type="number"], input[type="password"]');
  const fieldsWithoutAutocomplete = [];
  let allFieldsHaveAutocomplete = true;
  inputFields.each((_, el) => {
    const element = $2(el);
    const inputType = element.attr("type");
    const hasAutocomplete = element.attr("autocomplete") !== void 0;
    const id = element.attr("id") || "unknown";
    if (!hasAutocomplete) {
      let missingAutocomplete = "appropriate autocomplete attribute";
      if (inputType === "email")
        missingAutocomplete = 'autocomplete="email"';
      else if (inputType === "tel")
        missingAutocomplete = 'autocomplete="tel"';
      else if (id.includes("name"))
        missingAutocomplete = 'autocomplete="name"';
  ...
  return {
    ...
    passed: true,
    // For now, we'll assume this passes since it's a visual check
...
__name(analyzeInputPurpose, "analyzeInputPurpose");
function analyzeTargetSize($2) {
  const clickableElements = $2('a, button, input[type="submit"], input[type="button"], [role="button"]');
  const smallTargets = [];
  ...
  return {
    ...
    findings: allTargetsLargeEnough ? "All clickable elements appear to meet the minimum target size requirement." : "Some clickable elements are smaller than the recommended 24x24 CSS pixels.",
    elements: [
      { element: "Navigation links", isPassed: true },
      { element: "Form buttons", isPassed: true }
    ],
    howToFix: allTargetsLargeEnough ? void 0 : "Ensure all clickable elements are at least 24x24 CSS pixels in size."
  };
}
__name(analyzeTargetSize, "analyzeTargetSize");
function analyzeDraggingMovements($2) {
  const dragElements = $2('[draggable="true"]');
  const draggableWithoutAlternative = [];
  ...
  return {
    ...
    findings: dragElements.length === 0 ? "No draggable elements were found on the page." : allDraggableHaveAlternatives ? "All draggable elements have alternative ways to operate without dragging." : "Some draggable elements do not have alternatives to dragging operations.",
    elements: dragElements.length > 0 ? [{ element: "Draggable elements", isPassed: false, issue: "No alternative to drag operation" }] : [{ element: "No draggable elements found", isPassed: true }],
    howToFix: allDraggableHaveAlternatives ? void 0 : "Provide alternative methods (like buttons) to achieve the same functionality as dragging."
  };
}
__name(analyzeDraggingMovements, "analyzeDraggingMovements");
function analyzeConsistentHelp($2) {
  const helpElements = $2('a:contains("help"), a:contains("Help"), a:contains("support"), a:contains("Support")');
  let helpIsConsistent = true;
  const helpPositions = [];
  helpElements.each((_, el) => {
    const element = $2(el);
    const parent2 = element.parent();
    helpPositions.push(parent2.prop("tagName") || "unknown");
  });
  ...
  return {
    ...
    findings: helpElements.length === 0 ? "No explicit help mechanisms were found on the page." : helpIsConsistent ? "Help mechanisms are presented consistently across the page." : "Help mechanisms are not presented consistently across the page.",
    elements: helpElements.length > 0 ? [{ element: "Help links", isPassed: helpIsConsistent, issue: helpIsConsistent ? void 0 : "Inconsistent positioning" }] : [{ element: "No help mechanisms found", isPassed: true }],
    howToFix: helpIsConsistent ? void 0 : "Ensure help mechanisms are consistently positioned and styled across all pages."
  };
}
__name(analyzeConsistentHelp, "analyzeConsistentHelp");
function analyzeRedundantEntry($2) {
  const formElements = $2("form");
  let hasRedundantEntryIssues = false;
  if (formElements.length > 0) {
    const hasSaveButton = $2('button:contains("Save"), input[value="Save"]').length > 0;
    const hasMultiStep = $2(".step, .wizard, .multi-step").length > 0;
  ...
  return {
    ...
    findings: formElements.length === 0 ? "No forms requiring repeated information entry were found." : !hasRedundantEntryIssues ? "Forms appear to avoid redundant entry of information where appropriate." : "Some forms may require users to re-enter information that was previously provided.",
    elements: formElements.length > 0 ? [{
      element: "Multi-step forms",
      isPassed: !hasRedundantEntryIssues,
      issue: hasRedundantEntryIssues ? "Possible redundant information entry" : void 0
    }] : [{ element: "No multi-step forms found", isPassed: true }],
    howToFix: !hasRedundantEntryIssues ? void 0 : "Implement auto-save functionality or pre-fill previously entered information in multi-step forms."
  };
}
__name(analyzeRedundantEntry, "analyzeRedundantEntry");
function analyzeAccessibleAuthentication($2) {
  const loginForms = $2('form:has(input[type="password"])');
  const captchaElements = $2('[class*="captcha"], [id*="captcha"], img[src*="captcha"]');
  let hasCognitiveTest = captchaElements.length > 0;
  let hasAlternative = false;
  const hasOtherAuth = $2('button:contains("Sign in with"), button:contains("Login with")').length > 0;
  if (hasOtherAuth) {
    hasAlternative = true;
  }
  return {
    ...
    findings: loginForms.length === 0 ? "No authentication methods were found on the page." : hasCognitiveTest ? hasAlternative ? "Authentication uses cognitive tests (like CAPTCHA) but provides alternatives." : "Authentication relies on cognitive tests without alternatives." : "Authentication does not rely on cognitive tests.",
    elements: loginForms.length > 0 ? [{
      element: "Authentication forms",
      isPassed: !hasCognitiveTest || hasAlternative,
      issue: hasCognitiveTest && !hasAlternative ? "Uses CAPTCHA without alternatives" : void 0
    }] : [{ element: "No authentication forms found", isPassed: true }],
    howToFix: !hasCognitiveTest || hasAlternative ? void 0 : "Provide alternatives to CAPTCHA, such as email verification, SMS codes, or social media login options."
  };
}
__name(analyzeAccessibleAuthentication, "analyzeAccessibleAuthentication");
function analyzeAccessibleAuthenticationNoException($2) {
  const loginForms = $2('form:has(input[type="password"])');
  const captchaElements = $2('[class*="captcha"], [id*="captcha"], img[src*="captcha"]');
  let hasCognitiveTest = captchaElements.length > 0;
  return {
    ...
    findings: loginForms.length === 0 ? "No authentication methods were found on the page." : hasCognitiveTest ? "Authentication relies on cognitive tests." : "Authentication does not rely on cognitive tests.",
    elements: loginForms.length > 0 ? [{
      element: "Authentication forms",
      isPassed: !hasCognitiveTest,
      issue: hasCognitiveTest ? "Uses CAPTCHA or other cognitive tests" : void 0
    }] : [{ element: "No authentication forms found", isPassed: true }],
    howToFix: !hasCognitiveTest ? void 0 : "Replace CAPTCHA with non-cognitive verification methods like email verification, SMS codes, or WebAuthn."
  };
}
__name(analyzeAccessibleAuthenticationNoException, "analyzeAccessibleAuthenticationNoException");
  ...
  try {
    ...
    try {
      ...
      if (isAbortError(error3)) {
        throw fetchTimeoutError(timeoutMs, { cause: error3 });
      }
      if (error3 instanceof Error) {
        throw fetchFailureError({ cause: error3 });
      }
      throw error3;
    } finally {
    ...
    const results = [];
    let passedCount = 0;
    const focusNotObscuredMinResult = analyzeFocusAppearance($2);
    results.push(focusNotObscuredMinResult);
    if (focusNotObscuredMinResult.passed)
      passedCount++;
    const focusNotObscuredEnhancedResult = analyzeFocusVisible($2);
    results.push(focusNotObscuredEnhancedResult);
    if (focusNotObscuredEnhancedResult.passed)
      passedCount++;
    const focusAppearanceResult = analyzeInputPurpose($2);
    results.push(focusAppearanceResult);
    if (focusAppearanceResult.passed)
      passedCount++;
    const draggingMovementsResult = analyzeDraggingMovements($2);
    results.push(draggingMovementsResult);
    if (draggingMovementsResult.passed)
      passedCount++;
    const targetSizeResult = analyzeTargetSize($2);
    results.push(targetSizeResult);
    if (targetSizeResult.passed)
      passedCount++;
    const consistentHelpResult = analyzeConsistentHelp($2);
    results.push(consistentHelpResult);
    if (consistentHelpResult.passed)
      passedCount++;
    const redundantEntryResult = analyzeRedundantEntry($2);
    results.push(redundantEntryResult);
    if (redundantEntryResult.passed)
      passedCount++;
    const accessibleAuthMinResult = analyzeAccessibleAuthentication($2);
    results.push(accessibleAuthMinResult);
    if (accessibleAuthMinResult.passed)
      passedCount++;
    const accessibleAuthEnhancedResult = analyzeAccessibleAuthenticationNoException($2);
    results.push(accessibleAuthEnhancedResult);
    if (accessibleAuthEnhancedResult.passed)
      passedCount++;
    const nonTextContentResult = analyzeNonTextContent($2);
    results.push(nonTextContentResult);
    if (nonTextContentResult.passed)
      passedCount++;
    const audioVideoResult = analyzeAudioVideo($2);
    results.push(audioVideoResult);
    if (audioVideoResult.passed)
      passedCount++;
    const infoRelationshipsResult = analyzeInfoRelationships($2);
    results.push(infoRelationshipsResult);
    if (infoRelationshipsResult.passed)
      passedCount++;
    const useOfColorResult = analyzeUseOfColor($2);
    results.push(useOfColorResult);
    if (useOfColorResult.passed)
      passedCount++;
    const contrastResult = analyzeContrast($2);
    results.push(contrastResult);
    if (contrastResult.passed)
      passedCount++;
    const resizeTextResult = analyzeResizeText($2);
    results.push(resizeTextResult);
    if (resizeTextResult.passed)
      passedCount++;
    const keyboardResult = analyzeKeyboard($2);
    results.push(keyboardResult);
    if (keyboardResult.passed)
      passedCount++;
    const timingAdjustableResult = analyzeTimingAdjustable($2);
    results.push(timingAdjustableResult);
    if (timingAdjustableResult.passed)
      passedCount++;
    const threeFlashesResult = analyzeThreeFlashes($2);
    results.push(threeFlashesResult);
    if (threeFlashesResult.passed)
      passedCount++;
    const bypassBlocksResult = analyzeBypassBlocks($2, normalizedUrl);
    results.push(bypassBlocksResult);
    if (bypassBlocksResult.passed)
      passedCount++;
    const pageTitledResult = analyzePageTitled($2);
    results.push(pageTitledResult);
    if (pageTitledResult.passed)
      passedCount++;
    const focusOrderResult = analyzeFocusOrder($2);
    results.push(focusOrderResult);
    if (focusOrderResult.passed)
      passedCount++;
    const linkPurposeResult = analyzeLinkPurpose($2);
    results.push(linkPurposeResult);
    if (linkPurposeResult.passed)
      passedCount++;
    const focusVisibleResult = analyzeFocusVisible2($2);
    results.push(focusVisibleResult);
    if (focusVisibleResult.passed)
      passedCount++;
    const languageResult = analyzeLanguage($2);
    results.push(languageResult);
    if (languageResult.passed)
      passedCount++;
    const onFocusResult = analyzeOnFocus($2);
    results.push(onFocusResult);
    if (onFocusResult.passed)
      passedCount++;
    const errorIdentificationResult = analyzeErrorIdentification($2);
    results.push(errorIdentificationResult);
    if (errorIdentificationResult.passed)
      passedCount++;
    const nameRoleValueResult = analyzeNameRoleValue($2);
    results.push(nameRoleValueResult);
    if (nameRoleValueResult.passed)
      passedCount++;
    const totalCriteria = 27;
    const overallScore = Math.min(100, Math.round(passedCount / totalCriteria * 100));
    const tags = [
    ...
    console.error("Error analyzing website:", error3);
    throw new HttpError(
      500,
      "UNKNOWN_ERROR",
...
__name(analyzeWebsite, "analyzeWebsite");

// src/worker.ts
var app = new Hono2();
function parseTimeout(env2) {
  if (!env2.ANALYSIS_FETCH_TIMEOUT_MS) {
    return void 0;
  }
  const parsed = Number.parseInt(env2.ANALYSIS_FETCH_TIMEOUT_MS, 10);
  return Number.isFinite(parsed) && parsed > 0 ? parsed : void 0;
}
__name(parseTimeout, "parseTimeout");
app.onError((err, c) => {
...
app.post("/api/analyze", async (c) => {
  ...
  try {
    ...
    const { status, body } = toErrorResponse(error3);
    return c.json(body, status);
  }
});
